			...
			<div class="row">
				...
				<div id="nav" class="col-md-6">
					<ul>
						...
						<li><a href="${ createLink(controller:"Regalos",action:"elegirRegalo")}">Eliminar Regalo</a></li>
						<li><a href="${ createLink(controller:"Empleados",action:"elegirEmpleado")}">Eliminar Empleado</a></li>
					</ul>
				</div>
			</div>
			<div class="row">
